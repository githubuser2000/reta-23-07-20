...
let s:l = 1391 - ((28 * winheight(0) + 28) / 57)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 1988 - ((27 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1988
...
wincmd w
argglobal
if bufexists("~/workspace-noneclipse/reta/center.py") | buffer ~/workspace-noneclipse/reta/center.py | else | edit ~/workspace-noneclipse/reta/center.py | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <expr> <Right> TryKey('<Right>') ? '<Right>' : TooSoon('<RIGHT>','i')
inoremap <buffer> <silent> <expr> <Left> TryKey('<Left>') ? '<Left>' : TooSoon('<LEFT>','i')
...
set stal=1
badd +1988 reta.py
badd +0 ~/workspace-noneclipse/reta/center.py
