...
normal! 05|
tabnext
edit ~/workspace-noneclipse/reta/lib4tables.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 177 - ((28 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
177
normal! 09|
tabnext
edit ~/workspace-noneclipse/reta/lib4tables_concat.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 896 - ((47 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
896
normal! 033|
tabnext
edit ~/workspace-noneclipse/reta/lib4tables_prepare.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
249
normal! zo
let s:l = 338 - ((29 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
338
