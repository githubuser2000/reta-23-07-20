...
*** 2. Feature Ideen
+ eine Spalte programmieren: energie, gefühle, denken, materie, topologie
...
+ Syntax highlighting: hä?
+ dinge bei zsh abschauen: was kann zsh alles?
+ schöneres UTF: Ideen? Keine!
+ csv diff und insert geht schnell zu programmieren: die app ins git mogeln: recherche und KI
