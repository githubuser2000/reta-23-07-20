...
+ Befehl: "größe" oder "size" über Strukturgrößen für n und 1/n
+ Dass Py Formeln durch Python als Formeln interpretiert werden und eine Zahl ergeben: Dass es das ist mit regex überprüfen und nur umsetzen, wenn es kein sonstiger üblicher Zahlenbereich von reta ist.
